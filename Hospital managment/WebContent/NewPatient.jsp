...
input[type="text"], input[type="email"], input[type="password"],[type="number"] {
	font-size: 0.9em;
	color: #000;
	font-weight: 100;
	width: 94.5%;
	...
	background: -webkit-linear-gradient(top, rgba(255, 255, 255, 0) 96%,
		#000 4%);
	background: linear-gradient(to bottom, rgba(255, 255, 255, 0) 96%, #000
		4%);
...
@media ( max-width :480px) {
	...
	input[type="text"], input[type="email"], input[type="password"],[type="number"],Select {
		width: 91%;
	}
	.agileits-top p {
		font-size: 0.9em;
	...
	<div class="main-w3layouts wrapper">
		<h2 align="center">NEW PATIENT</h2>
			...
			<form action="AddServlet" method="post">
				<b></b> <label for="name"><b>Name</b></label> 
				<input class="text"
					onkeypress="return /[a-z]/i.test(event.key)" type="text"
					placeholder="Enter Name" name="name" id="name" required> 
				<label for="emailid">Email ID</label> 
				<input class="text" type="email" name="emailid"
					placeholder="Email" required> 
				
				<label for="age"><b>Age</b></label>
				<input class="text" type="number" placeholder="Enter Age" name="age" required> 
				...
				<label for="Doctor"><b>Please
							Select Doctor</b></label>
							 <select name="doctor" multiple="multiple" tabindex="1">
					<option value="Cronin">Cronin</option>
					<option value="Pixie">Pixie</option>
					<option value="Michael">Michael</option>
				</select>
				
				 <label for="mobno">Mobile
						Number </label> 
						<input type="number" placeholder="Enter Mobile Number"
					name="mno" type="number" required>
