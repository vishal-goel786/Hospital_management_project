...
function redirection(){
	...
	window.location = "DoctorsPage.jsp"; // Redirecting to other page.
	return false;
...
<% if ((name!=null)) { %>			
									<tr>	
										...
										<td><%=session.getAttribute("emailid")%></td>
											...
											<% if ((session.getAttribute("disease")!=null)||(session.getAttribute("medicine1")!=null)) { %>	
											<td><input type="submit" class="delete" id="show details"
											name="Show details" value="Completed"/></td>
											<%} %>
											<% if ((session.getAttribute("disease")==null)) { %>	
											<td><input type="submit" class="delete" id="show details"
											name="Show details" value="Pending"/></td>
											<%} %>
											<td><input type="submit" class="delete" id="show details"
